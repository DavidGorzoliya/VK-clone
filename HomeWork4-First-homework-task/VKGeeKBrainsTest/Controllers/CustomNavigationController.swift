...
final class animatorTwist90Push: NSObject, UIViewControllerAnimatedTransitioning {
    let duration = 1.0
...
final class animatorTwist90Pop: NSObject, UIViewControllerAnimatedTransitioning {
    let duration = 1.0
